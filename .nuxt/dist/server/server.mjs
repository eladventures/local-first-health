...
const _routes = [
  {
    name: "dentalemon",
    path: "/dentalemon",
    component: () => import("./_nuxt/dentalemon-GwTKRQVV.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-DRuZeY9Y.js")
  },
  {
    name: "waitlist",
    path: "/waitlist",
    component: () => import("./_nuxt/waitlist-BgLUXHz-.js")
  }
];
...
const namedMiddleware = {
  "exclude-route": () => import("./_nuxt/exclude-route-DCzyo_GV.js")
};
...
const layouts = {
  default: () => import("./_nuxt/Default-BZegKAeJ.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BKaN-Cmq.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DSRva2FU.js"));
