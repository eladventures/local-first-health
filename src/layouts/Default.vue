        ...
        <div class="container flex items-center justify-between h-12 mx-auto">
            ...
            <div class="flex items-center">
                ...
                >
                    <img
                        ...
                        alt="Your Logo"
                        class="object-contain w-auto h-8 mt-1 dark:text-default-400"
                    />
                </a> -->
            ...
            <div class="items-center flex-shrink-0 hidden lg:flex">
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="inline-block px-4 py-2 mt-5 text-sm font-semibold text-gray-800 bg-teal-100 rounded"
                >
                    Read Whitepaper
                </a>
            </div>
