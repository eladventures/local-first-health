...
import { ref, resolveComponent, mergeProps, useSSRContext, nextTick } from 'vue';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderStyle, ssrRenderList } from 'vue/server-renderer';
...
const _imports_0 = "" + buildAssetsURL("section-local-first-health-doctor-app.C88EEuYF.png");
const _imports_1 = "" + buildAssetsURL("section-local-first-health-mission-nurse-warning.D8JkBp9U.png");
const _imports_2 = "" + buildAssetsURL("local-first-image-reed-jobs-2.CK27XNao.png");
const _imports_3 = "" + buildAssetsURL("section-local-first-health-mission-nurse-cloud-problem.BFatAV25.png");
const _imports_4 = "" + buildAssetsURL("icons-data-breach.DOSz90IT.png");
const _imports_5 = "" + buildAssetsURL("icons-ransomware.DZ4q-OXc.png");
...
const _imports_7 = "" + buildAssetsURL("icons-no-cloud.Cq187nl5.png");
...
const _imports_9 = "" + buildAssetsURL("diagram-local-first-pre-cloud.CE16OO0W.png");
const _imports_10 = "" + buildAssetsURL("diagram-local-first-cloud-era.BhrR0YuA.png");
const _imports_11 = "" + buildAssetsURL("diagram-local-first-local-first-era.BClw7hAE.png");
const _imports_12 = "" + buildAssetsURL("local-first-health-ink-switch-paper.DH48Gm2z.png");
const _imports_13 = "" + buildAssetsURL("local-first-health-wired-magazine.Df1Hhiq7.png");
const _imports_14 = "" + buildAssetsURL("section-local-first-health-doctor-super.nQSo2g3b.png");
const _imports_15 = "" + buildAssetsURL("why-local-first-health-mission-doctor-work-offline.DYKuOJf4.png");
const _imports_16 = "" + buildAssetsURL("why-local-first-health-doctor-own-data.0cItx1-w.png");
const _imports_17 = "" + buildAssetsURL("why-local-first-health-doctor-own-the-software.FZeCFIk8.png");
const _imports_18 = "" + buildAssetsURL("why-local-first-health-mission-nurse-compliant.CqLuBigu.png");
const _imports_19 = "" + buildAssetsURL("why-local-first-health-doctor-data-privacy.BjRfwFis.png");
const _imports_20 = "" + buildAssetsURL("why-local-first-health-nurse-secure.DPidXQTM.png");
const _imports_21 = "" + buildAssetsURL("why-local-first-health-mission-lab-tech-fast.DputqfZK.png");
const _imports_22 = "" + buildAssetsURL("why-local-first-health-pharmacist-collaborate.BBgytfzy.png");
const _imports_23 = "" + buildAssetsURL("why-local-first-health-mission-nurse-synced.CIQBMCz8.png");
const _imports_24 = "" + buildAssetsURL("why-local-first-health-mission-lab-tech-decentralized.DDLM-C6S.png");
const _imports_25 = "" + buildAssetsURL("why-local-first-health-mission-pharmacist-open.5cxNucUa.png");
const _imports_26 = "" + buildAssetsURL("why-local-first-health-lab-tech-freedom.cyKqYZfh.png");
const _imports_27 = "" + buildAssetsURL("section-local-first-health-down._-lSueiW.png");
const _imports_28 = "" + buildAssetsURL("local-first-health-suite-easy-joey.D17FqL94.png");
const _imports_29 = "" + buildAssetsURL("local-first-health-suite-dentalemon.BZtflxqW.png");
const _imports_30 = "" + buildAssetsURL("local-first-health-suite-parmago.BFbpowo6.png");
const _imports_31 = "" + buildAssetsURL("local-first-health-suite-diagnozip.BnwFAyzD.png");
const _imports_32 = "" + buildAssetsURL("local-first-health-suite-ospitalis.y0SyTjcD.png");
const _imports_33 = "" + buildAssetsURL("easy-joey-1.DoKu5k6k.mp4");
const _imports_34 = "" + buildAssetsURL("local-first-health-team.BfGIWY3M.png");
...
const _imports_37 = "" + buildAssetsURL("local-first-health-hands-2.B-mO-qJm.png");
const _imports_38 = "" + buildAssetsURL("local-first-health-logo-location-brown.Cwt8VQsB.png");
const _sfc_main$2 = {
  __name: "NewsCard",
...
const ogBanner = "" + buildAssetsURL("local-first-health-banner.CdGD9QSS.png");
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
...
//# sourceMappingURL=index-DRuZeY9Y.mjs.map
