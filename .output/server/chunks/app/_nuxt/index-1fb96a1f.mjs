...
const _imports_0 = "" + buildAssetsURL("local-first-health-hands-2.2a299bd0.png");
const _imports_1 = "" + buildAssetsURL("local-first-health-frustrated.8c1264fb.png");
const _imports_2 = "" + buildAssetsURL("local-first-health-happy.d0bbba87.png");
const _imports_3 = "" + buildAssetsURL("local-first-health-what-is-local-first.fe17cff6.png");
const _imports_4 = "" + buildAssetsURL("local-first-health-papaya.460a8e39.png");
const _imports_5 = "" + buildAssetsURL("local-first-health-suite.8f65fadc.png");
const _imports_6 = "" + buildAssetsURL("local-first-health-suite-mycure-blue-apple.759054b6.png");
const _imports_7 = "" + buildAssetsURL("local-first-health-suite-parmazip-berry.e1d42d23.png");
const _imports_8 = "" + buildAssetsURL("local-first-health-suite-ospitalis-green-coco.355bcf47.png");
const _imports_9 = "" + buildAssetsURL("local-first-health-suite-easyjoey-durian.dcf70bd3.png");
const _imports_10 = "" + buildAssetsURL("local-first-health-own-software-own-data.e0933055.png");
...
const _imports_13 = "" + buildAssetsURL("local-first-health-logo-footer.bf3d467f.png");
...
//# sourceMappingURL=index-1fb96a1f.mjs.map
